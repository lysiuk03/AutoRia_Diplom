...
import UploadPhoto from "../PostAdPageComponents/addphoto.tsx";
...
const AdForm: React.FC = () => {
    ...
    const onHandleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        const formData = {
            ...
            engineVolume: selectedEngineVolume,
            ...
            color: selectedColor,
            accidentStatus: selectedAccidentStatus,
            technicalState: selectedTechnicalState,
            accessory: selectedAccessory,
            vin: (document.querySelector('.vin-input') as HTMLInputElement).value,
            description: (document.querySelector('.description-input') as HTMLTextAreaElement).value,
            // Add any additional fields you want to include
        };

        // Send the data to the backend
        try {
            await axios.post('http://localhost:5174/api/Car', formData);
    ...
    return (
        <form className="ad-form-container" onSubmit={onHandleSubmit}>
